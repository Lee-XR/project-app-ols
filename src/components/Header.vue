<template>
  <div class="sticky top-0 w-full bg-white dark:bg-gray-700 shadow-md z-50 transition duration-100 ease-in-out">
    ...
    <div class="flex flex-row justify-between items-center px-5 py-5">
      ...
      <div class="flex flex-row justify-center items-center">
        <button @click="openNav" class="bg-primary rounded-full w-10 h-10 flex flex-col justify-center border-2
        border-primary text-white drop-shadow-md hover:bg-white hover:text-primary hover:scale-x-105 peer">
        ...
        <div ref="menu" class="uppercase text-3xl px-4 py-1 drop-shadow-lg rounded-r-full -translate-x-1 opacity-0 transition ease-in-out
        duration-300 peer-hover:opacity-100 peer-hover:translate-x-2 peer-hover:bg-gradient-to-r
        peer-hover:from-transparent peer-hover:to-gray-300 peer-hover:scale-x-105 
      ...
      <div class="flex justify-evenly items-center">
        ...
        <!-- Logout button -->
        <button @click="logout" class="bg-primary rounded-full w-10 h-10 flex flex-col justify-center border-2
        border-primary text-white drop-shadow-md hover:bg-white hover:text-primary">
